...
#source('~/Desktop/SCMsimulation/ScmSimulation/SCM_EstimateFunction.R')
# data_scm <- data.scm(
...
# 
#   plot.scm(data_scm, intervention_Time)

# 
# 
# 
# result.SCM <- SCM.sample(data_scm, seed.sample, sample.percent,  intervention_Time)
# data_plot <- result.SCM$sample.data_SCM
# plot.scm.sam(data_plot, intervention_Time)




# script SCM_EstimateFunction.R.R
#
# the purpose of this script is to use Synthetic Control Method to estimate the weight parameter
#
# first version: 160404
# this version:  160404
# last change by: Yujiao Li
...
source('~/Desktop/SCMsimulation/ScmSimulation/SCM_Function.R')
source('~/Desktop/SCMsimulation/ScmSimulation/SCM_PlotTrendFunction.R')
...
#   seed.control = seed.control )
# 
# rep.result<-rep.scm(rep.times, seed.replicate,
#         data_scm, 
#         sample.percent,  intervention_Time)
# 
# rep.result
